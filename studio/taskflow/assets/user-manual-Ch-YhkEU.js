const e=`Welcome to TaskFlow - your powerful task management companion! This guide covers every feature and aspect of TaskFlow to help you master productive task management.
...
### 1️⃣ Import or Start Fresh
TaskFlow automatically starts with a new "Untitled" file. To load existing tasks, click "Import Task File".
...
#### File Management
- **Import File**: Load existing TaskFlow file
...
##### File Operations
- **Import File**: Load existing file
