...
// SalesPerformanceDashboard: KPI tiles + mini charts composition.\r
export const meta = {\r
  id: 'sales-performance-dashboard',\r
  title: 'Sales Performance Dashboard',\r
  desc: 'Sales Performance Dashboard — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'SalesPerformanceDashboard',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","sales-performance-dashboard"],\r
}\r
\r
export default function SalesPerformanceDashboard({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x', 24).attr('y', 34).attr('font-size', '11px').attr('font-weight', 700)\r
      .attr('fill', 'var(--text-secondary)').text('SalesPerformance · This Week')\r
    const kpis = [["Revenue","$1.2M",8],["Orders","3,482",-2],["Conv.","3.2%",4]]\r
    kpis.forEach((k, i) => {\r
      const x = 24 + i * 122\r
    ...
    const bars = [["EU",34],["US",44],["APAC",22]]\r
    let by = 178\r
    bars.forEach((b, i) => {\r
