...
export const meta = {\r
  id: 'diverging-bar-outliers-v2',\r
  title: 'Diverging Bar Outliers V2',\r
  desc: 'Diverging Bar Outliers V2 — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'DivergingBarOutliersV2',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","diverging-bar-outliers-v2"],\r
}\r
\r
export default function DivergingBarOutliersV2({ data: customData }) {\r
  const ref=useRef(null)\r
  useEffect(()=>{\r
    const svg=d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT=[{cat:'A',v:-18},{cat:'B',v:22},{cat:'C',v:-9},{cat:'D',v:14},{cat:'E',v:-6},{cat:'F',v:42}]\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Diverging Outliers V2')\r
  },[customData])\r
