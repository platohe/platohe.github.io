...
// SeoScoreDashboard: KPI tiles + mini charts composition.\r
export const meta = {\r
  id: 'seo-score-dashboard',\r
  title: 'Seo Score Dashboard',\r
  desc: 'Seo Score Dashboard — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'SeoScoreDashboard',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","seo-score-dashboard"],\r
}\r
\r
export default function SeoScoreDashboard({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x', 24).attr('y', 34).attr('font-size', '11px').attr('font-weight', 700)\r
      .attr('fill', 'var(--text-secondary)').text('SeoScore · This Week')\r
    const kpis = [["Score","92/100",4],["Keywords","1,842",9],["Backlinks","12.4k",6]]\r
    kpis.forEach((k, i) => {\r
      const x = 24 + i * 122\r
    ...
    const bars = [["On-page",46],["Tech",31],["Links",23]]\r
    let by = 178\r
    bars.forEach((b, i) => {\r
