...
export const meta = {\r
  id: 'area-with-newton-raphson-trend',\r
  title: 'Area With Newton Raphson Trend',\r
  desc: 'Area With Newton Raphson Trend — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithNewtonRaphsonTrend',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-newton-raphson-trend"],\r
}\r
\r
export default function AreaWithNewtonRaphsonTrend({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Newton-Raphson trend finding (root finding on derivative)\r
    const trend=curveData.map((_,i)=>{\r
      ...
      return {x:i, y:curveData[i].y + (Math.random()-0.5)*2}\r
    })\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Newton-Raphson Trend')\r
