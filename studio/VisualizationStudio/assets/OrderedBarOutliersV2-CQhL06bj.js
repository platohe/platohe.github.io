...
export const meta = {\r
  id: 'ordered-bar-outliers-v2',\r
  title: 'Ordered Bar Outliers V2',\r
  desc: 'Ordered Bar Outliers V2 — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'OrderedBarOutliersV2',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","ordered-bar-outliers-v2"],\r
}\r
\r
export default function OrderedBarOutliersV2({ data: customData }) {\r
  const ref=useRef(null)\r
  useEffect(()=>{\r
    const svg=d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT=[{cat:'Alpha',v:42},{cat:'Beta',v:68},{cat:'Gamma',v:34},{cat:'Delta',v:55},{cat:'Epsilon',v:88}]\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Ordered Bar Outliers V2')\r
  },[customData])\r
