...
export const meta = {\r
  id: 'pie-chart-ring',\r
  title: 'Pie Chart Ring',\r
  desc: 'Pie Chart Ring — a radial chart visualization',\r
  category: 'Radial',\r
  component: 'PieChartRing',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["radial","pie-chart-ring"],\r
}\r
\r
export default function PieChartRing({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const arc = d3.arc().innerRadius(45).outerRadius(95)\r
