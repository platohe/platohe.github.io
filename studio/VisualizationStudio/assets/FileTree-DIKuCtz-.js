...
// FileTree: File system listing style.\r
export const meta = {\r
  id: 'file-tree',\r
  title: 'File Tree',\r
  desc: 'File Tree — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'FileTree',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["bars","file-tree"],\r
}\r
\r
export default function FileTree({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"name":"project/","children":[{"name":"src/","children":[{"name":"app.jsx"},{"name":"util.js"}]},{"name":"tests/"},{"name":"README.md"}]}\r
