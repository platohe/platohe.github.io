...
export const meta = {\r
  id: 'spike-map-geo-json2',\r
  title: 'Spike Map Geo J S O N2',\r
  desc: 'Spike Map Geo J S O N2 — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'SpikeMapGeoJSON2',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","spike-map-geo-j-s-o-n2"],\r
}\r
\r
export default function SpikeMapGeoJSON2({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    \r
    \r
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('SpikeMapGeoJSON2 - geoAlbersUsa')\r
  }, [customData])\r
