...
// VoronoiTreemapDepth: Nested polygonal treemap variant 3.\r
export const meta = {\r
  id: 'voronoi-treemap-depth',\r
  title: 'Voronoi Treemap Depth',\r
  desc: 'Voronoi Treemap Depth — a math & simulation chart visualization',\r
  category: 'Math & Simulation',\r
  component: 'VoronoiTreemapDepth',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["math-&-simulation","voronoi-treemap-depth"],\r
}\r
\r
export default function VoronoiTreemapDepth({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    void customData\r
    const g = svg.append('g')\r
    const rawWeights = [["L1",30,0],["L2a",20,1],["L2b",20,2],["L3",15,3],["L4",9,4]]\r
