...
// SunburstRings: Concentric emphasis rings.\r
export const meta = {\r
  id: 'sunburst-rings',\r
  title: 'Sunburst Rings',\r
  desc: 'Sunburst Rings — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'SunburstRings',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","sunburst-rings"],\r
}\r
\r
export default function SunburstRings({ data: customData }) {\r
