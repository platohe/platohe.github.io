...
export const meta = {\r
  id: 'area-with-light-gbmtrend',\r
  title: 'Area With Light G B M Trend',\r
  desc: 'Area With Light G B M Trend — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithLightGBMTrend',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-light-g-b-m-trend"],\r
}\r
\r
export default function AreaWithLightGBMTrend({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // LightGBM-style gradient boosting\r
    const trees=50\r
    const lr=0.05\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with LightGBM Trend')\r
