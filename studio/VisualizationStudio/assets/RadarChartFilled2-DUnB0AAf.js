...
\r
export const meta = {\r
  id: 'radar-chart-filled2',\r
  title: 'Radar Chart Filled2',\r
  desc: 'Radar Chart Filled2 — a fun chart visualization',\r
  category: 'Fun',\r
  component: 'RadarChartFilled2',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["fun","radar-chart-filled2"],\r
}\r
\r
export default function RadarChartFilled2({ data: customData }) {\r
