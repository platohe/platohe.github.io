...
export const meta = {\r
  id: 'area-with-alpha-zero',\r
  title: 'Area With Alpha Zero',\r
  desc: 'Area With Alpha Zero — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithAlphaZero',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-alpha-zero"],\r
}\r
\r
export default function AreaWithAlphaZero({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    for(let i=0;i<10;i++){\r
      ...
      selfPlay.push(path)\r
    }\r
    selfPlay.forEach(path=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with AlphaZero')\r
