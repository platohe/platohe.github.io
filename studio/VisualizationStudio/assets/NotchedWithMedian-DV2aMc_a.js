...
export const meta = {\r
  id: 'notched-with-median',\r
  title: 'Notched With Median',\r
  desc: 'Notched With Median — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'NotchedWithMedian',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","notched-with-median"],\r
}\r
\r
export default function NotchedWithMedian({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Notched with Median')\r
  },[customData])\r
