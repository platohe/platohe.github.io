...
// LogisticsTrackerDashboard: KPI tiles + mini charts composition.\r
export const meta = {\r
  id: 'logistics-tracker-dashboard',\r
  title: 'Logistics Tracker Dashboard',\r
  desc: 'Logistics Tracker Dashboard — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'LogisticsTrackerDashboard',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","logistics-tracker-dashboard"],\r
}\r
\r
export default function LogisticsTrackerDashboard({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x', 24).attr('y', 34).attr('font-size', '11px').attr('font-weight', 700)\r
      .attr('fill', 'var(--text-secondary)').text('LogisticsTracker · This Week')\r
    const kpis = [["Shipments","3,902",7],["On-time","94.2%",1],["Fleet Use","87%",5]]\r
    kpis.forEach((k, i) => {\r
      const x = 24 + i * 122\r
    ...
    const bars = [["Road",56],["Rail",18],["Air",26]]\r
    let by = 178\r
    bars.forEach((b, i) => {\r
