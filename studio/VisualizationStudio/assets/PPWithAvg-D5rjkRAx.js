...
export const meta = {\r
  id: 'ppwith-avg',\r
  title: 'P P With Avg',\r
  desc: 'P P With Avg — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'PPWithAvg',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","p-p-with-avg"],\r
}\r
\r
export default function PPWithAvg({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    series.forEach((s,i)=>{\r
      ...
      g.append('circle').attr('cx',x(avgTh)).attr('cy',y(0.5)).attr('r',3).attr('fill',colors[i]).attr('stroke','var(--bg)')\r
    })\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('P-P with Avg')\r
  },[customData])\r
