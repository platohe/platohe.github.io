...
export const meta = {\r
  id: 'letter-value-with-median',\r
  title: 'Letter Value With Median',\r
  desc: 'Letter Value With Median — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'LetterValueWithMedian',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","letter-value-with-median"],\r
}\r
\r
export default function LetterValueWithMedian({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Letter-Value with Median')\r
  },[customData])\r
