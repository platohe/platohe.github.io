...
export const meta = {\r
  id: 'bivariate-choropleth-geo-json',\r
  title: 'Bivariate Choropleth Geo J S O N',\r
  desc: 'Bivariate Choropleth Geo J S O N — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'BivariateChoroplethGeoJSON',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","bivariate-choropleth-geo-j-s-o-n"],\r
}\r
\r
export default function BivariateChoroplethGeoJSON({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    \r
    \r
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('BivariateChoroplethGeoJSON - geoEqualEarth')\r
  }, [customData])\r
