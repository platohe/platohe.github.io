...
// IsometricBars3d: IsometricBars3d — isometric pseudo-3D.\r
export const meta = {\r
  id: 'isometric-bars3d',\r
  title: 'Isometric Bars3d',\r
  desc: 'Isometric Bars3d — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'IsometricBars3d',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","isometric-bars3d"],\r
}\r
\r
export default function IsometricBars3d({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    void proj\r
const vals=[['A',34],['B',52],['C',40],['D',64],['E',28]]\r
    ...
    vals.forEach((v,i)=>box(i*22, 0, 0, 16, 16, v[1]*0.8, ['#6366f1','#f59e0b','#10b981','#ef4444','#8b5cf6'][i]))\r
  }, [customData])\r
