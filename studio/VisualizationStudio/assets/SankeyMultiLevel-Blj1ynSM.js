...
// SankeyMultiLevel: Four-stage supply chain.\r
export const meta = {\r
  id: 'sankey-multi-level',\r
  title: 'Sankey Multi Level',\r
  desc: 'Sankey Multi Level — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'SankeyMultiLevel',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","sankey-multi-level"],\r
}\r
\r
export default function SankeyMultiLevel({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"name":"Raw"},{"name":"Parts"},{"name":"Assembly"},{"name":"Retail"}],"links":[{"source":0,"target":1,"value":40},{"source":0,"target":2,"value":20},{"source":1,"target":2,"value":30},{"source":1,"target":3,"value":10},{"source":2,"target":3,"value":45}]}\r
