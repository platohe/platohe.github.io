...
export const meta = {\r
  id: 'area-with-avg',\r
  title: 'Area With Avg',\r
  desc: 'Area With Avg — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithAvg',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-avg"],\r
}\r
\r
export default function AreaWithAvg({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    const avg=d3.mean(curveData,d=>d.y)||0\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Avg')\r
