...
export const meta = {\r
  id: 'area-with-multi-armed-bandit-ts',\r
  title: 'Area With Multi Armed Bandit T S',\r
  desc: 'Area With Multi Armed Bandit T S — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithMultiArmedBanditTS',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-multi-armed-bandit-t-s"],\r
}\r
\r
export default function AreaWithMultiArmedBanditTS({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Multi-armed bandit with Thompson sampling\r
    const arms=3\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Multi-Armed Bandit TS')\r
