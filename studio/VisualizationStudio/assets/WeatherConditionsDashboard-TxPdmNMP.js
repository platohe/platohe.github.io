...
// WeatherConditionsDashboard: KPI tiles + mini charts composition.\r
export const meta = {\r
  id: 'weather-conditions-dashboard',\r
  title: 'Weather Conditions Dashboard',\r
  desc: 'Weather Conditions Dashboard — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'WeatherConditionsDashboard',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","weather-conditions-dashboard"],\r
}\r
\r
export default function WeatherConditionsDashboard({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x', 24).attr('y', 34).attr('font-size', '11px').attr('font-weight', 700)\r
      .attr('fill', 'var(--text-secondary)').text('WeatherConditions · This Week')\r
    const kpis = [["Temp","23°C",5],["Humidity","48%",-6],["Wind","12km/h",2]]\r
    kpis.forEach((k, i) => {\r
      const x = 24 + i * 122\r
    ...
    const bars = [["Sun",62],["Cloud",26],["Rain",12]]\r
    let by = 178\r
    bars.forEach((b, i) => {\r
