...
// ArcDiagramHierarchical: Parent-child reporting lines only, downward arcs.\r
export const meta = {\r
  id: 'arc-diagram-hierarchical',\r
  title: 'Arc Diagram Hierarchical',\r
  desc: 'Arc Diagram Hierarchical — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ArcDiagramHierarchical',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","arc-diagram-hierarchical"],\r
}\r
\r
export default function ArcDiagramHierarchical({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"id":"co","name":"Acme"},{"id":"en","name":"Engineering"},{"id":"pr","name":"Product"},{"id":"fe","name":"Frontend"},{"id":"be","name":"Backend"},{"id":"ux","name":"UX"},{"id":"pm","name":"PM"}],"links":[{"source":"co","target":"en","value":1},{"source":"co","target":"pr","value":1},{"source":"en","target":"fe","value":1},{"source":"en","target":"be","value":1},{"source":"pr","target":"ux","value":1},{"source":"pr","target":"pm","value":1}]}\r
...
\r
    ...
    data.links.forEach(lk => {\r
      ...
      const w = 2\r
      const lift = -28 - Math.abs(x2-x1)*0.15\r
      const cxm = (x1+x2)/2\r
      g.append('path')\r
