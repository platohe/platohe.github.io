...
// SankeyWide: Full-width layout.\r
export const meta = {\r
  id: 'sankey-wide',\r
  title: 'Sankey Wide',\r
  desc: 'Sankey Wide — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'SankeyWide',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","sankey-wide"],\r
}\r
\r
export default function SankeyWide({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"name":"Coal"},{"name":"Gas"},{"name":"Solar"},{"name":"Grid"},{"name":"Homes"}],"links":[{"source":0,"target":3,"value":28},{"source":1,"target":4,"value":32},{"source":2,"target":3,"value":24},{"source":3,"target":4,"value":36}]}\r
    const data = (customData && customData.nodes && customData.links) ? customData : DEFAULT_DATA\r
    const sk = d3Sankey.sankey()\r
      .nodeWidth(14)\r
      .nodePadding(18)\r
      .extent([[12, 44], [388, 258]])\r
