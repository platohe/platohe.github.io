...
// FitnessTrackerDashboard: KPI tiles + mini charts composition.\r
export const meta = {\r
  id: 'fitness-tracker-dashboard',\r
  title: 'Fitness Tracker Dashboard',\r
  desc: 'Fitness Tracker Dashboard — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'FitnessTrackerDashboard',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","fitness-tracker-dashboard"],\r
}\r
\r
export default function FitnessTrackerDashboard({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x', 24).attr('y', 34).attr('font-size', '11px').attr('font-weight', 700)\r
      .attr('fill', 'var(--text-secondary)').text('FitnessTracker · This Week')\r
    const kpis = [["Steps","9,842",10],["Calories","612",-6],["Sleep","7h20m",4]]\r
    kpis.forEach((k, i) => {\r
      const x = 24 + i * 122\r
    ...
    const bars = [["Cardio",48],["Strength",32],["Mobility",20]]\r
    let by = 178\r
    bars.forEach((b, i) => {\r
