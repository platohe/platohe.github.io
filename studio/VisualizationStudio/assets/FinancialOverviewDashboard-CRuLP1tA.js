...
// FinancialOverviewDashboard: KPI tiles + mini charts composition.\r
export const meta = {\r
  id: 'financial-overview-dashboard',\r
  title: 'Financial Overview Dashboard',\r
  desc: 'Financial Overview Dashboard — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'FinancialOverviewDashboard',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","financial-overview-dashboard"],\r
}\r
\r
export default function FinancialOverviewDashboard({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x', 24).attr('y', 34).attr('font-size', '11px').attr('font-weight', 700)\r
      .attr('fill', 'var(--text-secondary)').text('FinancialOverview · This Week')\r
    const kpis = [["Cash","$4.2M",3],["Burn","$310k",-5],["Runway","13 mo",2]]\r
    kpis.forEach((k, i) => {\r
      const x = 24 + i * 122\r
    ...
    const bars = [["Rev",52],["OpEx",31],["Tax",17]]\r
    let by = 178\r
    bars.forEach((b, i) => {\r
