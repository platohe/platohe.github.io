...
export const meta = {\r
  id: 'area-with-bfgs',\r
  title: 'Area With B F G S',\r
  desc: 'Area With B F G S — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithBFGS',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-b-f-g-s"],\r
}\r
\r
export default function AreaWithBFGSOptimization({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with BFGS Optimization')\r
