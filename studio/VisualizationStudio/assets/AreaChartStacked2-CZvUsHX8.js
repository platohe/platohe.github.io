...
\r
export const meta = {\r
  id: 'area-chart-stacked2',\r
  title: 'Area Chart Stacked2',\r
  desc: 'Area Chart Stacked2 — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaChartStacked2',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-chart-stacked2"],\r
}\r
\r
export default function AreaChartStacked2({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const timeKey = data[0] && (data[0].month !== undefined || data[0].date !== undefined)\r
      ? (data[0].month !== undefined ? 'month' : 'date')\r
      : null\r
