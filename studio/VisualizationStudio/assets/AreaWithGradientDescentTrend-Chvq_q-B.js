...
export const meta = {\r
  id: 'area-with-gradient-descent-trend',\r
  title: 'Area With Gradient Descent Trend',\r
  desc: 'Area With Gradient Descent Trend — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithGradientDescentTrend',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-gradient-descent-trend"],\r
}\r
\r
export default function AreaWithGradientDescentTrend({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Gradient descent trend fitting\r
    let theta=40, trend=[]\r
    curveData.forEach(d=>{\r
      const pred=theta*d.x\r
      const error=d.y-pred\r
      theta+=0.01*error*d.x // gradient descent step\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Gradient Descent Trend')\r
