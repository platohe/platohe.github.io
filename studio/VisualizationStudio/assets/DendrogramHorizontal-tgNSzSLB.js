...
// DendrogramHorizontal: Classic horizontal dendrogram.\r
export const meta = {\r
  id: 'dendrogram-horizontal',\r
  title: 'Dendrogram Horizontal',\r
  desc: 'Dendrogram Horizontal — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'DendrogramHorizontal',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","dendrogram-horizontal"],\r
}\r
\r
export default function DendrogramHorizontal({ data: customData }) {\r
