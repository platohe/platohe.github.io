...
// ParallelCoordinatesColored: Lines colored per car type.\r
export const meta = {\r
  id: 'parallel-coordinates-colored',\r
  title: 'Parallel Coordinates Colored',\r
  desc: 'Parallel Coordinates Colored — a lines chart visualization',\r
  category: 'Lines',\r
  component: 'ParallelCoordinatesColored',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["lines","parallel-coordinates-colored"],\r
}\r
\r
export default function ParallelCoordinatesColored({ data: customData }) {\r
