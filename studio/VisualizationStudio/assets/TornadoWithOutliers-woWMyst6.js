...
export const meta = {\r
  id: 'tornado-with-outliers',\r
  title: 'Tornado With Outliers',\r
  desc: 'Tornado With Outliers — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'TornadoWithOutliers',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","tornado-with-outliers"],\r
}\r
\r
export default function TornadoWithOutliers({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Tornado with Outliers')\r
  },[customData])\r
