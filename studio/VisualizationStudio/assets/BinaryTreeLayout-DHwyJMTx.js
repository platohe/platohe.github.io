...
// BinaryTreeLayout: Binary search layout.\r
export const meta = {\r
  id: 'binary-tree-layout',\r
  title: 'Binary Tree Layout',\r
  desc: 'Binary Tree Layout — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'BinaryTreeLayout',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["bars","binary-tree-layout"],\r
}\r
\r
export default function BinaryTreeLayout({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"name":"50","children":[{"name":"30","children":[{"name":"20"},{"name":"40"}]},{"name":"70","children":[{"name":"60"},{"name":"80"}]}]}\r
