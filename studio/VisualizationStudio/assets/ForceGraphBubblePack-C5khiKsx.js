...
// ForceGraphBubblePack: Front-chain style pack.\r
export const meta = {\r
  id: 'force-graph-bubble-pack',\r
  title: 'Force Graph Bubble Pack',\r
  desc: 'Force Graph Bubble Pack — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphBubblePack',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-bubble-pack"],\r
}\r
\r
export default function ForceGraphBubblePack({ data: customData }) {\r
