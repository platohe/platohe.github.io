...
// HrMetricsDashboard: KPI tiles + mini charts composition.\r
export const meta = {\r
  id: 'hr-metrics-dashboard',\r
  title: 'Hr Metrics Dashboard',\r
  desc: 'Hr Metrics Dashboard — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'HrMetricsDashboard',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","hr-metrics-dashboard"],\r
}\r
\r
export default function HrMetricsDashboard({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x', 24).attr('y', 34).attr('font-size', '11px').attr('font-weight', 700)\r
      .attr('fill', 'var(--text-secondary)').text('HrMetrics · This Week')\r
    const kpis = [["Headcount","428",5],["Attrition","6.1%",-9],["eNPS","+41",7]]\r
    kpis.forEach((k, i) => {\r
      const x = 24 + i * 122\r
    ...
    const bars = [["Eng",38],["Sales",29],["G&A",33]]\r
    let by = 178\r
    bars.forEach((b, i) => {\r
