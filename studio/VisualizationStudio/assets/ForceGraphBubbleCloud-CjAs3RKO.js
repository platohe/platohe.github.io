...
// ForceGraphBubbleCloud: Force-positioned bubble cloud.\r
export const meta = {\r
  id: 'force-graph-bubble-cloud',\r
  title: 'Force Graph Bubble Cloud',\r
  desc: 'Force Graph Bubble Cloud — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphBubbleCloud',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-bubble-cloud"],\r
}\r
\r
export default function ForceGraphBubbleCloud({ data: customData }) {\r
