...
export const meta = {\r
  id: 'area-with-watermark',\r
  title: 'Area With Watermark',\r
  desc: 'Area With Watermark — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithWatermark',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-watermark"],\r
}\r
\r
export default function AreaWithWatermark({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Watermark\r
    g.append('text').attr('x',width/2).attr('y',height/2).attr('text-anchor','middle').attr('dominant-baseline','middle').attr('fill',colors[0]).attr('fill-opacity',0.05).attr('font-size','48px').attr('font-weight',700).text('DEMO')\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Watermark')\r
