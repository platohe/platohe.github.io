...
// ParallelCoordinatesSmooth: Catmull-Rom smoothed curves.\r
export const meta = {\r
  id: 'parallel-coordinates-smooth',\r
  title: 'Parallel Coordinates Smooth',\r
  desc: 'Parallel Coordinates Smooth — a lines chart visualization',\r
  category: 'Lines',\r
  component: 'ParallelCoordinatesSmooth',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["lines","parallel-coordinates-smooth"],\r
}\r
\r
export default function ParallelCoordinatesSmooth({ data: customData }) {\r
...
\r
    ...
    data.rows.forEach((r, idx) => {\r
      ...
      g.append('path').attr('d', d3.line().x(p => p[0]).y(p => p[1]).curve(d3.curveCatmullRom.alpha(0.6))(pts)).attr('fill', 'none')\r
