...
// RealEstateDashboard: KPI tiles + mini charts composition.\r
export const meta = {\r
  id: 'real-estate-dashboard',\r
  title: 'Real Estate Dashboard',\r
  desc: 'Real Estate Dashboard — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'RealEstateDashboard',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","real-estate-dashboard"],\r
}\r
\r
export default function RealEstateDashboard({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x', 24).attr('y', 34).attr('font-size', '11px').attr('font-weight', 700)\r
      .attr('fill', 'var(--text-secondary)').text('RealEstate · This Week')\r
    const kpis = [["Listings","312",5],["Median","$742k",3],["DOM","21d",-9]]\r
    kpis.forEach((k, i) => {\r
      const x = 24 + i * 122\r
    ...
    const bars = [["House",52],["Condo",31],["Land",17]]\r
    let by = 178\r
    bars.forEach((b, i) => {\r
