...
export const meta = {\r
  id: 'box-with-deviation',\r
  title: 'Box With Deviation',\r
  desc: 'Box With Deviation — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'BoxWithDeviation',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","box-with-deviation"],\r
}\r
\r
export default function BoxWithDeviation({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Box with Deviation')\r
  },[customData])\r
