...
\r
export const meta = {\r
  id: 'bar-chart-vertical3',\r
  title: 'Bar Chart Vertical3',\r
  desc: 'Bar Chart Vertical3 — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'BarChartVertical3',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis","d3-shape"],\r
  tags: ["bars","bar-chart-vertical3"],\r
}\r
\r
export default function BarChartVertical3({ data: customData }) {\r
