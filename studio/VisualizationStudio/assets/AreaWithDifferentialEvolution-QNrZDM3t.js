...
export const meta = {\r
  id: 'area-with-differential-evolution',\r
  title: 'Area With Differential Evolution',\r
  desc: 'Area With Differential Evolution — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithDifferentialEvolution',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-differential-evolution"],\r
}\r
\r
export default function AreaWithDifferentialEvolution({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    for(let gen=0;gen<5;gen++){\r
      // Mutation, crossover, selection\r
    }\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Differential Evolution')\r
