...
export const meta = {\r
  id: 'area-with-online-change-point',\r
  title: 'Area With Online Change Point',\r
  desc: 'Area With Online Change Point — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithOnlineChangePoint',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-online-change-point"],\r
}\r
\r
export default function AreaWithOnlineChangePoint({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Online change point detection (streaming)\r
    let runLength=0\r
    const threshold=0.05\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Online Change Point')\r
