...
export const meta = {\r
  id: 'funnel-with-outliers',\r
  title: 'Funnel With Outliers',\r
  desc: 'Funnel With Outliers — a fun chart visualization',\r
  category: 'Fun',\r
  component: 'FunnelWithOutliers',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["fun","funnel-with-outliers"],\r
}\r
\r
export default function FunnelWithOutliers({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Funnel with Outliers')\r
  },[customData])\r
