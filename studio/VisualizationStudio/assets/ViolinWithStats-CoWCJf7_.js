...
export const meta = {\r
  id: 'violin-with-stats',\r
  title: 'Violin With Stats',\r
  desc: 'Violin With Stats — a analysis chart visualization',\r
  category: 'Analysis',\r
  component: 'ViolinWithStats',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["analysis","violin-with-stats"],\r
}\r
\r
export default function ViolinWithStats({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    groups.forEach((gr,i)=>{\r
      ...
      g.append('circle').attr('cx',cx).attr('cy',y(m)).attr('r',3).attr('fill',colors[i]).attr('stroke','#fff').attr('stroke-width',1)\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Violin with Stats')\r
  },[customData])\r
