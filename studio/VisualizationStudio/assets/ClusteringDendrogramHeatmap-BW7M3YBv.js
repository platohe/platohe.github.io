...
// ClusteringDendrogramHeatmap: ward linkage.\r
export const meta = {\r
  id: 'clustering-dendrogram-heatmap',\r
  title: 'Clustering Dendrogram Heatmap',\r
  desc: 'Clustering Dendrogram Heatmap — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'ClusteringDendrogramHeatmap',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy","d3-color"],\r
  tags: ["bars","clustering-dendrogram-heatmap"],\r
}\r
\r
export default function ClusteringDendrogramHeatmap({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    leaves.forEach((l, i) => {\r
      g.append('rect').attr('x', xs[i] - 12).attr('y', 218).attr('width', 24).attr('height', 10)\r
        .attr('fill', colors[i % colors.length]).attr('fill-opacity', 0.8).attr('rx', 2)\r
    })\r
