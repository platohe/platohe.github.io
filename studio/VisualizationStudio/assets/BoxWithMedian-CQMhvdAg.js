...
export const meta = {\r
  id: 'box-with-median',\r
  title: 'Box With Median',\r
  desc: 'Box With Median — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'BoxWithMedian',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","box-with-median"],\r
}\r
\r
export default function BoxWithMedian({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Box with Median')\r
  },[customData])\r
