...
// ArcDiagramSocial: Two friend communities, distinct hues.\r
export const meta = {\r
  id: 'arc-diagram-social',\r
  title: 'Arc Diagram Social',\r
  desc: 'Arc Diagram Social — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ArcDiagramSocial',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","arc-diagram-social"],\r
}\r
\r
export default function ArcDiagramSocial({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"id":"av","name":"Ava"},{"id":"li","name":"Liam"},{"id":"no","name":"Noah"},{"id":"mi","name":"Mia"},{"id":"eth","name":"Ethan"},{"id":"zo","name":"Zoe"}],"links":[{"source":"av","target":"li","value":3},{"source":"av","target":"no","value":2},{"source":"li","target":"mi","value":2},{"source":"no","target":"mi","value":3},{"source":"eth","target":"zo","value":2},{"source":"mi","target":"zo","value":1}]}\r
    const data = (customData && customData.nodes && customData.links) ? customData : DEFAULT_DATA\r
    const g = svg.append('g')\r
\r
    const comm = new Map([[0,0],[1,0],[2,0],[3,0],[4,1],[5,1]])\r
