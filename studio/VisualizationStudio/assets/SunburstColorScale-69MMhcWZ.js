...
import { W, H, palette } from './utils'\r
// SunburstColorScale: Sequential scale by value.\r
export const meta = {\r
  id: 'sunburst-color-scale',\r
  title: 'Sunburst Color Scale',\r
  desc: 'Sunburst Color Scale — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'SunburstColorScale',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","sunburst-color-scale"],\r
}\r
\r
export default function SunburstColorScale({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const colorFor = (d) => d3.interpolateRgbBasis([palette.primary, palette.secondary, palette.tertiary])((d.value || 0) / root.value)\r
