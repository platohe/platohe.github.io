...
export const meta = {\r
  id: 'mercator-projection',\r
  title: 'Mercator Projection',\r
  desc: 'Mercator Projection — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'MercatorProjection',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","mercator-projection"],\r
}\r
\r
export default function MercatorProjection({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    \r
    \r
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('MercatorProjection - geoConicEqualArea')\r
  }, [customData])\r
