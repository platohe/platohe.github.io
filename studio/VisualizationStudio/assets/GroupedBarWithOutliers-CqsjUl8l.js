...
export const meta = {\r
  id: 'grouped-bar-with-outliers',\r
  title: 'Grouped Bar With Outliers',\r
  desc: 'Grouped Bar With Outliers — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'GroupedBarWithOutliers',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","grouped-bar-with-outliers"],\r
}\r
\r
export default function GroupedBarWithOutliers({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Grouped Bar with Outliers')\r
  },[customData])\r
