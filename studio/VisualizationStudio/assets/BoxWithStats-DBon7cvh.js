...
export const meta = {\r
  id: 'box-with-stats',\r
  title: 'Box With Stats',\r
  desc: 'Box With Stats — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'BoxWithStats',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","box-with-stats"],\r
}\r
\r
export default function BoxWithStats({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Box with Stats')\r
  },[customData])\r
