...
export const meta = {\r
  id: 'dasymetric-geo-json2',\r
  title: 'Dasymetric Geo J S O N2',\r
  desc: 'Dasymetric Geo J S O N2 — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'DasymetricGeoJSON2',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","dasymetric-geo-j-s-o-n2"],\r
}\r
\r
export default function DasymetricGeoJSON2({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    \r
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('DasymetricGeoJSON2 - geoEqualEarth')\r
  }, [customData])\r
