...
export const meta = {\r
  id: 'area-with-empirical-wavelet',\r
  title: 'Area With Empirical Wavelet',\r
  desc: 'Area With Empirical Wavelet — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithEmpiricalWavelet',\r
  complexity: 'beginner',\r
  interactivity: ["animate"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-empirical-wavelet"],\r
}\r
\r
export default function AreaWithEmpiricalWavelet({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Empirical wavelet decomposition\r
    const levels=4\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Empirical Wavelet')\r
