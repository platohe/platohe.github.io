...
// TaxonomyTree: Radial taxonomy.\r
export const meta = {\r
  id: 'taxonomy-tree',\r
  title: 'Taxonomy Tree',\r
  desc: 'Taxonomy Tree — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'TaxonomyTree',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["bars","taxonomy-tree"],\r
}\r
\r
export default function TaxonomyTree({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"name":"Animalia","children":[{"name":"Mammals","children":[{"name":"Whale"},{"name":"Bat"}]},{"name":"Birds","children":[{"name":"Owl"},{"name":"Hawk"},{"name":"Crow"}]},{"name":"Reptiles","children":[{"name":"Gecko"}]}]}\r
