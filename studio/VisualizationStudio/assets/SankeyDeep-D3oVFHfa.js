...
// SankeyDeep: Five-level chain.\r
export const meta = {\r
  id: 'sankey-deep',\r
  title: 'Sankey Deep',\r
  desc: 'Sankey Deep — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'SankeyDeep',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","sankey-deep"],\r
}\r
\r
export default function SankeyDeep({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"name":"Ore"},{"name":"Metal"},{"name":"Component"},{"name":"Device"},{"name":"Consumer"}],"links":[{"source":0,"target":1,"value":50},{"source":1,"target":2,"value":42},{"source":2,"target":3,"value":38},{"source":3,"target":4,"value":34}]}\r
