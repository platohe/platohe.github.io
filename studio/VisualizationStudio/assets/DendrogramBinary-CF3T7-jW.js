...
// DendrogramBinary: Strict binary merge data.\r
export const meta = {\r
  id: 'dendrogram-binary',\r
  title: 'Dendrogram Binary',\r
  desc: 'Dendrogram Binary — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'DendrogramBinary',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","dendrogram-binary"],\r
}\r
\r
export default function DendrogramBinary({ data: customData }) {\r
