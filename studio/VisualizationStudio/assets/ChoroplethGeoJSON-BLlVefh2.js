...
export const meta = {\r
  id: 'choropleth-geo-json',\r
  title: 'Choropleth Geo J S O N',\r
  desc: 'Choropleth Geo J S O N — a maps chart visualization',\r
  category: 'Maps',\r
  component: 'ChoroplethGeoJSON',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["maps","choropleth-geo-j-s-o-n"],\r
}\r
\r
export default function ChoroplethGeoJSON({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    \r
    \r
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('ChoroplethGeoJSON - geoMercator')\r
  }, [customData])\r
