...
// ForceGraphDraggable: Drag-handle styling on nodes.\r
export const meta = {\r
  id: 'force-graph-draggable',\r
  title: 'Force Graph Draggable',\r
  desc: 'Force Graph Draggable — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphDraggable',\r
  complexity: 'beginner',\r
  interactivity: ["drag"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-draggable"],\r
}\r
\r
export default function ForceGraphDraggable({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const DEFAULT_DATA = { nodes: [\r
      ...
      links: [{"source":0,"target":1,"value":1},{"source":1,"target":2,"value":1},{"source":2,"target":0,"value":1},{"source":3,"target":4,"value":1},{"source":4,"target":5,"value":1},{"source":5,"target":3,"value":1},{"source":0,"target":3,"value":1}] }\r
