...
export const meta = {\r
  id: 'equal-earth-projection',\r
  title: 'Equal Earth Projection',\r
  desc: 'Equal Earth Projection — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'EqualEarthProjection',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","equal-earth-projection"],\r
}\r
\r
export default function EqualEarthProjection({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    \r
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('EqualEarthProjection - geoAlbersUsa')\r
  }, [customData])\r
