...
export const meta = {\r
  id: 'ecdfwith-ci',\r
  title: 'E C D F With C I',\r
  desc: 'E C D F With C I — a analysis chart visualization',\r
  category: 'Analysis',\r
  component: 'ECDFWithCI',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["analysis","e-c-d-f-with-c-i"],\r
}\r
\r
export default function ECDFWithCI({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('ECDF with CI')\r
  },[customData])\r
