...
// ForceGraphRadial: Radial group arrangement.\r
export const meta = {\r
  id: 'force-graph-radial',\r
  title: 'Force Graph Radial',\r
  desc: 'Force Graph Radial — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphRadial',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-radial"],\r
}\r
\r
export default function ForceGraphRadial({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const DEFAULT_DATA = { nodes: [\r
      ...
      links: [{"source":0,"target":3,"value":1},{"source":0,"target":4,"value":1},{"source":0,"target":5,"value":1},{"source":0,"target":6,"value":1},{"source":0,"target":7,"value":1},{"source":0,"target":8,"value":1}] }\r
    ...
    const centers = [200, 150]\r
    const pos = data.nodes.map((nd, i) => {\r
      const ang = (i / data.nodes.length) * Math.PI * 2 - Math.PI / 2\r
      return { nd, x: centers[0] + Math.cos(ang) * 95, y: centers[1] + Math.sin(ang) * 78 }\r
    })\r
