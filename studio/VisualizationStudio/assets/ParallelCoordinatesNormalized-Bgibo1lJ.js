...
// ParallelCoordinatesNormalized: Axes normalized to 0-100.\r
export const meta = {\r
  id: 'parallel-coordinates-normalized',\r
  title: 'Parallel Coordinates Normalized',\r
  desc: 'Parallel Coordinates Normalized — a lines chart visualization',\r
  category: 'Lines',\r
  component: 'ParallelCoordinatesNormalized',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["lines","parallel-coordinates-normalized"],\r
}\r
\r
export default function ParallelCoordinatesNormalized({ data: customData }) {\r
