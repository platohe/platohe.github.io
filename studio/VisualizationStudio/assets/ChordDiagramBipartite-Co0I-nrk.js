...
// ChordDiagramBipartite: Suppliers and plants — within-side flows are zero.\r
export const meta = {\r
  id: 'chord-diagram-bipartite',\r
  title: 'Chord Diagram Bipartite',\r
  desc: 'Chord Diagram Bipartite — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ChordDiagramBipartite',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","chord-diagram-bipartite"],\r
}\r
\r
export default function ChordDiagramBipartite({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = { names: ["Mill A","Mill B","Plant X","Plant Y"], matrix: [[0,0,60,30],[0,0,20,55],[60,20,0,0],[30,55,0,0]] }\r
