...
// ForceGraphLabeled: Every node labeled.\r
export const meta = {\r
  id: 'force-graph-labeled',\r
  title: 'Force Graph Labeled',\r
  desc: 'Force Graph Labeled — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphLabeled',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-labeled"],\r
}\r
\r
export default function ForceGraphLabeled({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const DEFAULT_DATA = { nodes: [\r
      ...
      links: [{"source":0,"target":1,"value":1},{"source":1,"target":2,"value":1},{"source":2,"target":3,"value":1},{"source":3,"target":4,"value":1},{"source":4,"target":0,"value":1}] }\r
