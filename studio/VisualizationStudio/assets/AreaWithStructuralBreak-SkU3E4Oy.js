...
export const meta = {\r
  id: 'area-with-structural-break',\r
  title: 'Area With Structural Break',\r
  desc: 'Area With Structural Break — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithStructuralBreak',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-structural-break"],\r
}\r
\r
export default function AreaWithStructuralBreak({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Bai-Perron structural break test\r
    const breaks=[30, 40] // known break points\r
    ...
    g.append('path').datum(curveData).attr('d',area).attr('fill',colors[0]).attr('fill-opacity',0.18).attr('stroke',colors[0]).attr('stroke-width',1.6)\r
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Structural Break')\r
