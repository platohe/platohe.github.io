...
export const meta = {\r
  id: 'volume-candlestick',\r
  title: 'Volume Candlestick',\r
  desc: 'Volume Candlestick — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'VolumeCandlestick',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-transition"],\r
  tags: ["bars","volume-candlestick"],\r
}\r
\r
export default function VolumeCandlestick({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x',W/2).attr('y',M.top-4).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('VolumeCandlestick')\r
  }, [customData])\r
