...
// ForceGraphWeighted: Edge width encodes weight.\r
export const meta = {\r
  id: 'force-graph-weighted',\r
  title: 'Force Graph Weighted',\r
  desc: 'Force Graph Weighted — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphWeighted',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-weighted"],\r
}\r
\r
export default function ForceGraphWeighted({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const DEFAULT_DATA = { nodes: [\r
      ...
      links: [{"source":3,"target":0,"value":5},{"source":4,"target":1,"value":6},{"source":5,"target":1,"value":7},{"source":6,"target":2,"value":8}] }\r
    ...
    data.links.forEach(lk => {\r
      ...
      g.append('line').attr('x1', s.x).attr('y1', s.y).attr('x2', t.x).attr('y2', t.y)\r
        ...
        .attr('stroke-width', 1 + 3.4 * ((lk.value || 1) / maxV))\r
