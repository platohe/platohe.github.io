...
// SankeyBudget: Household budget allocation.\r
export const meta = {\r
  id: 'sankey-budget',\r
  title: 'Sankey Budget',\r
  desc: 'Sankey Budget — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'SankeyBudget',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","sankey-budget"],\r
}\r
\r
export default function SankeyBudget({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"name":"Income"},{"name":"Rent"},{"name":"Food"},{"name":"Fun"},{"name":"Savings"}],"links":[{"source":0,"target":1,"value":35},{"source":0,"target":2,"value":20},{"source":0,"target":3,"value":15},{"source":0,"target":4,"value":30}]}\r
