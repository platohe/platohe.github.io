...
export const meta = {\r
  id: 'stacked-bar-with-error',\r
  title: 'Stacked Bar With Error',\r
  desc: 'Stacked Bar With Error — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'StackedBarWithError',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","stacked-bar-with-error"],\r
}\r
\r
export default function StackedBarWithError({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Stacked Bar with Error')\r
  },[customData])\r
