...
// ForceGraphDirected: Arrowheads show direction.\r
export const meta = {\r
  id: 'force-graph-directed',\r
  title: 'Force Graph Directed',\r
  desc: 'Force Graph Directed — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphDirected',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-directed"],\r
}\r
\r
export default function ForceGraphDirected({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const DEFAULT_DATA = { nodes: [\r
      ...
      links: [{"source":0,"target":3,"value":1},{"source":1,"target":4,"value":1},{"source":2,"target":5,"value":1},{"source":3,"target":6,"value":1},{"source":4,"target":7,"value":1},{"source":5,"target":8,"value":1}] }\r
    ...
    defs.append('marker').attr('id', 'fg-arrow').attr('viewBox', '0 0 8 8').attr('refX', 9).attr('refY', 4)\r
      .attr('markerWidth', 5).attr('markerHeight', 5).attr('orient', 'auto')\r
      .append('path').attr('d', 'M0 0 L8 4 L0 8 z').attr('fill', '#94a3b8')\r
