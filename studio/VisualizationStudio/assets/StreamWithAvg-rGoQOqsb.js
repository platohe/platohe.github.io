...
export const meta = {\r
  id: 'stream-with-avg',\r
  title: 'Stream With Avg',\r
  desc: 'Stream With Avg — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'StreamWithAvg',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","stream-with-avg"],\r
}\r
\r
export default function StreamWithAvg({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Stream with Avg')\r
  },[customData])\r
