...
export const meta = {\r
  id: 'line-break-chart',\r
  title: 'Line Break Chart',\r
  desc: 'Line Break Chart — a lines chart visualization',\r
  category: 'Lines',\r
  component: 'LineBreakChart',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["lines","line-break-chart"],\r
}\r
\r
export default function LineBreakChart({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    pts.forEach((d,i)=>{\r
      ...
      g.append('line').attr('x1',x(d.date)+bw/2).attr('x2',x(d.date)+bw/2).attr('y1',y(d.high)).attr('y2',y(d.low)).attr('stroke',col).attr('stroke-width',2)\r
    ...
    g.append('text').attr('x',W/2).attr('y',M.top-4).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('LineBreakChart')\r
  }, [customData])\r
