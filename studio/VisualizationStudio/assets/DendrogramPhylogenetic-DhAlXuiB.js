...
// DendrogramPhylogenetic: Distance-scaled phylogeny style.\r
export const meta = {\r
  id: 'dendrogram-phylogenetic',\r
  title: 'Dendrogram Phylogenetic',\r
  desc: 'Dendrogram Phylogenetic — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'DendrogramPhylogenetic',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","dendrogram-phylogenetic"],\r
}\r
\r
export default function DendrogramPhylogenetic({ data: customData }) {\r
