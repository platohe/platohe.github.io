...
export const meta = {\r
  id: 'ordered-bar-with-ci',\r
  title: 'Ordered Bar With C I',\r
  desc: 'Ordered Bar With C I — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'OrderedBarWithCI',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","ordered-bar-with-c-i"],\r
}\r
\r
export default function OrderedBarWithCI({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Ordered Bar with CI')\r
  },[customData])\r
