...
// ChordDiagramRegional: Three macro-regions, chunky flows.\r
export const meta = {\r
  id: 'chord-diagram-regional',\r
  title: 'Chord Diagram Regional',\r
  desc: 'Chord Diagram Regional — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ChordDiagramRegional',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","chord-diagram-regional"],\r
}\r
\r
export default function ChordDiagramRegional({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = { names: ["AMER","EMEA","APAC"], matrix: [[0,45,38],[45,0,52],[38,52,0]] }\r
