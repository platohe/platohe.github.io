...
// ParallelCoordinatesExplorer: Axis titles plus legend.\r
export const meta = {\r
  id: 'parallel-coordinates-explorer',\r
  title: 'Parallel Coordinates Explorer',\r
  desc: 'Parallel Coordinates Explorer — a lines chart visualization',\r
  category: 'Lines',\r
  component: 'ParallelCoordinatesExplorer',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["lines","parallel-coordinates-explorer"],\r
}\r
\r
export default function ParallelCoordinatesExplorer({ data: customData }) {\r
...
\r
    ...
    ;['Family', 'Sport', 'Utility'].forEach((nm, ci) => {\r
      g.append('rect').attr('x', W - 116).attr('y', 16 + ci * 15).attr('width', 9).attr('height', 9).attr('rx', 2).attr('fill', colors[ci % colors.length])\r
      g.append('text').attr('x', W - 102).attr('y', 24 + ci * 15).attr('font-size', '8.5px').attr('fill', 'var(--text-secondary)').text(nm)\r
    })\r
    void data\r
  }, [customData])\r
