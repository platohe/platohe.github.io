...
\r
export const meta = {\r
  id: 'pie-chart-segmented2',\r
  title: 'Pie Chart Segmented2',\r
  desc: 'Pie Chart Segmented2 — a radial chart visualization',\r
  category: 'Radial',\r
  component: 'PieChartSegmented2',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["radial","pie-chart-segmented2"],\r
}\r
\r
export default function PieChartSegmented2({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const arc = d3.arc().innerRadius(25).outerRadius(90)\r
