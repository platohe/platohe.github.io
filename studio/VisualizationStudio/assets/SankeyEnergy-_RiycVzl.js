...
// SankeyEnergy: Energy balance story.\r
export const meta = {\r
  id: 'sankey-energy',\r
  title: 'Sankey Energy',\r
  desc: 'Sankey Energy — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'SankeyEnergy',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","sankey-energy"],\r
}\r
\r
export default function SankeyEnergy({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"name":"Coal"},{"name":"Gas"},{"name":"Solar"},{"name":"Grid"},{"name":"Homes"},{"name":"Industry"}],"links":[{"source":0,"target":3,"value":35},{"source":1,"target":3,"value":40},{"source":2,"target":3,"value":20},{"source":3,"target":4,"value":50},{"source":3,"target":5,"value":40}]}\r
