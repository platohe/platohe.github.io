...
export const meta = {\r
  id: 'notched-with-deviation',\r
  title: 'Notched With Deviation',\r
  desc: 'Notched With Deviation — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'NotchedWithDeviation',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","notched-with-deviation"],\r
}\r
\r
export default function NotchedWithDeviation({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Notched with Deviation')\r
  },[customData])\r
