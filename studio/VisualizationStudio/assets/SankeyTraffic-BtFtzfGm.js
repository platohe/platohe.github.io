...
// SankeyTraffic: Visitor funnel through site.\r
export const meta = {\r
  id: 'sankey-traffic',\r
  title: 'Sankey Traffic',\r
  desc: 'Sankey Traffic — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'SankeyTraffic',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","sankey-traffic"],\r
}\r
\r
export default function SankeyTraffic({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"name":"Visit"},{"name":"Browse"},{"name":"Cart"},{"name":"Checkout"},{"name":"Bounce"}],"links":[{"source":0,"target":1,"value":80},{"source":0,"target":4,"value":20},{"source":1,"target":2,"value":45},{"source":1,"target":4,"value":35},{"source":2,"target":3,"value":30},{"source":2,"target":4,"value":15}]}\r
