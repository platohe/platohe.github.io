...
// ArcDiagramSparse: Four strong protein interactions, large nodes.\r
export const meta = {\r
  id: 'arc-diagram-sparse',\r
  title: 'Arc Diagram Sparse',\r
  desc: 'Arc Diagram Sparse — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ArcDiagramSparse',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","arc-diagram-sparse"],\r
}\r
\r
export default function ArcDiagramSparse({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"id":"p1","name":"Insulin"},{"id":"p2","name":"Glucagon"},{"id":"p3","name":"Amylin"},{"id":"p4","name":"Ghrelin"},{"id":"p5","name":"Leptin"}],"links":[{"source":"p1","target":"p2","value":5},{"source":"p1","target":"p3","value":4},{"source":"p2","target":"p4","value":3},{"source":"p3","target":"p5","value":2}]}\r
...
\r
    ...
    data.nodes.forEach((n,i)=>{\r
      ...
      g.append('circle').attr('cx',x).attr('cy',y0).attr('r',7).attr('fill',nodeColor(i)).attr('stroke','var(--bg)')\r
      const flip = x > W/2\r
