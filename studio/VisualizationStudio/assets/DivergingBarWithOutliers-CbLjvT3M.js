...
export const meta = {\r
  id: 'diverging-bar-with-outliers',\r
  title: 'Diverging Bar With Outliers',\r
  desc: 'Diverging Bar With Outliers — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'DivergingBarWithOutliers',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","diverging-bar-with-outliers"],\r
}\r
\r
export default function DivergingBarWithOutliers({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Diverging Bar with Outliers')\r
  },[customData])\r
