...
// ForceGraphBubbleSwarm: Tight swarm packing.\r
export const meta = {\r
  id: 'force-graph-bubble-swarm',\r
  title: 'Force Graph Bubble Swarm',\r
  desc: 'Force Graph Bubble Swarm — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphBubbleSwarm',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-bubble-swarm"],\r
}\r
\r
export default function ForceGraphBubbleSwarm({ data: customData }) {\r
