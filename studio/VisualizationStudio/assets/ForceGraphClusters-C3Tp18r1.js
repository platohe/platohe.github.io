...
// ForceGraphClusters: Three tight clusters.\r
export const meta = {\r
  id: 'force-graph-clusters',\r
  title: 'Force Graph Clusters',\r
  desc: 'Force Graph Clusters — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphClusters',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-clusters"],\r
}\r
\r
export default function ForceGraphClusters({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const DEFAULT_DATA = { nodes: [\r
      ...
      links: [{"source":0,"target":1,"value":1},{"source":1,"target":2,"value":1},{"source":3,"target":4,"value":1},{"source":4,"target":5,"value":1},{"source":6,"target":7,"value":1},{"source":7,"target":8,"value":1}] }\r
