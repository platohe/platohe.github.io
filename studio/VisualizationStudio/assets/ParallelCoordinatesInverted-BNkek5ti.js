...
// ParallelCoordinatesInverted: Cost axis inverted so up means cheaper.\r
export const meta = {\r
  id: 'parallel-coordinates-inverted',\r
  title: 'Parallel Coordinates Inverted',\r
  desc: 'Parallel Coordinates Inverted — a lines chart visualization',\r
  category: 'Lines',\r
  component: 'ParallelCoordinatesInverted',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["lines","parallel-coordinates-inverted"],\r
}\r
\r
export default function ParallelCoordinatesInverted({ data: customData }) {\r
