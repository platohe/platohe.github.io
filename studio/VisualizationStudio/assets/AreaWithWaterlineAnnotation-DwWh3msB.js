...
export const meta = {\r
  id: 'area-with-waterline-annotation',\r
  title: 'Area With Waterline Annotation',\r
  desc: 'Area With Waterline Annotation — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithWaterlineAnnotation',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-waterline-annotation"],\r
}\r
\r
export default function AreaWithWaterlineAnnotation({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    const waterline=45\r
    g.append('rect').attr('x',0).attr('y',y(waterline)).attr('width',width).attr('height',y(0)-y(waterline)).attr('fill','#dbeafe').attr('opacity',0.3)\r
    g.append('line').attr('x1',0).attr('x2',width).attr('y1',y(waterline)).attr('y2',y(waterline)).attr('stroke','#3b82f6').attr('stroke-width',1.2).attr('stroke-dasharray','3,2')\r
    g.append('text').attr('x',width-2).attr('y',y(waterline)-4).attr('text-anchor','end').attr('fill','#3b82f6').attr('font-size','7px').attr('font-weight',600).text('Waterline 45')\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Waterline Annotation')\r
