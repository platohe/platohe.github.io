...
export const meta = {\r
  id: 'area-with-threshold-shading',\r
  title: 'Area With Threshold Shading',\r
  desc: 'Area With Threshold Shading — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithThresholdShading',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-threshold-shading"],\r
}\r
\r
export default function AreaWithThresholdShading({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Threshold shading\r
    const threshold=45\r
    g.append('rect').attr('x',0).attr('y',y(threshold)).attr('width',width).attr('height',y(0)-y(threshold)).attr('fill','#fee2e2').attr('opacity',0.3)\r
    g.append('rect').attr('x',0).attr('y',y(70)).attr('width',width).attr('height',y(0)-y(70)).attr('fill','#dcfce7').attr('opacity',0.3)\r
    ...
    g.append('line').attr('x1',0).attr('x2',width).attr('y1',y(50)).attr('y2',y(50)).attr('stroke','#f59e0b').attr('stroke-dasharray','3,2')\r
    ...
    g.append('text').attr('x',width-4).attr('y',y(50)-6).attr('text-anchor','end').attr('fill','#f59e0b').attr('font-size','7px').text('threshold')\r
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Threshold Shading')\r
