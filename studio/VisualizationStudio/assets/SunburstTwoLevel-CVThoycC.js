...
// SunburstTwoLevel: Two-level ring only.\r
export const meta = {\r
  id: 'sunburst-two-level',\r
  title: 'Sunburst Two Level',\r
  desc: 'Sunburst Two Level — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'SunburstTwoLevel',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","sunburst-two-level"],\r
}\r
\r
export default function SunburstTwoLevel({ data: customData }) {\r
