...
export const meta = {\r
  id: 'joyplot-with-avg',\r
  title: 'Joyplot With Avg',\r
  desc: 'Joyplot With Avg — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'JoyplotWithAvg',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","joyplot-with-avg"],\r
}\r
\r
export default function JoyplotWithAvg({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Joyplot with Avg')\r
  },[customData])\r
