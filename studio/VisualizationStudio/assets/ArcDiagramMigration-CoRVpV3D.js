...
// ArcDiagramMigration: Corridor thickness = migrant flow.\r
export const meta = {\r
  id: 'arc-diagram-migration',\r
  title: 'Arc Diagram Migration',\r
  desc: 'Arc Diagram Migration — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ArcDiagramMigration',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","arc-diagram-migration"],\r
}\r
\r
export default function ArcDiagramMigration({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"id":"in","name":"India"},{"id":"pk","name":"Pakistan"},{"id":"bd","name":"Bangladesh"},{"id":"ae","name":"UAE"},{"id":"uk","name":"UK"},{"id":"us","name":"USA"}],"links":[{"source":"in","target":"ae","value":9},{"source":"pk","target":"ae","value":7},{"source":"bd","target":"ae","value":5},{"source":"in","target":"uk","value":4},{"source":"pk","target":"uk","value":2},{"source":"in","target":"us","value":6}]}\r
