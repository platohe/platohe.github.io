...
export const meta = {\r
  id: 'notched-with-avg',\r
  title: 'Notched With Avg',\r
  desc: 'Notched With Avg — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'NotchedWithAvg',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","notched-with-avg"],\r
}\r
\r
export default function NotchedWithAvg({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Notched with Avg')\r
  },[customData])\r
