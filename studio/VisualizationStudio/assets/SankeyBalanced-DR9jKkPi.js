...
// SankeyBalanced: Symmetric splits at every node.\r
export const meta = {\r
  id: 'sankey-balanced',\r
  title: 'Sankey Balanced',\r
  desc: 'Sankey Balanced — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'SankeyBalanced',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","sankey-balanced"],\r
}\r
\r
export default function SankeyBalanced({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"name":"Src"},{"name":"L"},{"name":"R"},{"name":"LL"},{"name":"LR"},{"name":"RL"},{"name":"RR"}],"links":[{"source":0,"target":1,"value":25},{"source":0,"target":2,"value":25},{"source":1,"target":3,"value":13},{"source":1,"target":4,"value":12},{"source":2,"target":5,"value":13},{"source":2,"target":6,"value":12}]}\r
