...
// ArcDiagramSorted: Nodes ordered by connection count.\r
export const meta = {\r
  id: 'arc-diagram-sorted',\r
  title: 'Arc Diagram Sorted',\r
  desc: 'Arc Diagram Sorted — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ArcDiagramSorted',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","arc-diagram-sorted"],\r
}\r
\r
export default function ArcDiagramSorted({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"id":"react","name":"React"},{"id":"vue","name":"Vue"},{"id":"svelte","name":"Svelte"},{"id":"angular","name":"Angular"},{"id":"solid","name":"Solid"},{"id":"preact","name":"Preact"}],"links":[{"source":"solid","target":"react","value":4},{"source":"preact","target":"react","value":5},{"source":"vue","target":"react","value":2},{"source":"svelte","target":"vue","value":3},{"source":"angular","target":"react","value":1},{"source":"solid","target":"vue","value":1}]}\r
