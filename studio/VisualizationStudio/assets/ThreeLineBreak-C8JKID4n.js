...
export const meta = {\r
  id: 'three-line-break',\r
  title: 'Three Line Break',\r
  desc: 'Three Line Break — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'ThreeLineBreak',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","three-line-break"],\r
}\r
\r
export default function ThreeLineBreak({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x',W/2).attr('y',M.top-4).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('ThreeLineBreak')\r
  }, [customData])\r
