...
// KMedoidsClustering: Medoid stars per cluster.\r
export const meta = {\r
  id: 'kmedoids-clustering',\r
  title: 'K Medoids Clustering',\r
  desc: 'K Medoids Clustering — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'KMedoidsClustering',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["bars","k-medoids-clustering"],\r
}\r
\r
export default function KMedoidsClustering({ data: customData }) {\r
...
\r
    ;[[28,33],[71,67],[45,18]].forEach(c=>{ g.append('path').attr('d','M'+(M.left+x(c[0])-7)+' '+(M.top+y(c[1]))+' h14 M'+(M.left+x(c[0]))+' '+(M.top+y(c[1])-7)+' v14').attr('stroke','#ef4444').attr('stroke-width',2) })\r
  }, [customData])\r
