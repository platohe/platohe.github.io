...
// AffinityPropagation: Exemplars highlighted.\r
export const meta = {\r
  id: 'affinity-propagation',\r
  title: 'Affinity Propagation',\r
  desc: 'Affinity Propagation — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'AffinityPropagation',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","affinity-propagation"],\r
}\r
\r
export default function AffinityPropagation({ data: customData }) {\r
