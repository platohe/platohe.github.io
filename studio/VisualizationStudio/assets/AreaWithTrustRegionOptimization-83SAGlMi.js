...
export const meta = {\r
  id: 'area-with-trust-region-optimization',\r
  title: 'Area With Trust Region Optimization',\r
  desc: 'Area With Trust Region Optimization — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithTrustRegionOptimization',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-trust-region-optimization"],\r
}\r
\r
export default function AreaWithTrustRegion({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Trust region optimization path\r
    const trustRadius=5\r
    ...
    // Trust region circle\r
    g.append('circle').attr('cx',width/2).attr('cy',height/2).attr('r',50).attr('fill','none').attr('stroke','#f59e0b').attr('stroke-width',2).attr('stroke-dasharray','4,4')\r
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Trust Region')\r
