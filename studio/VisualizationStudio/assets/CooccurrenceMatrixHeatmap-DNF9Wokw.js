...
export const meta = {\r
  id: 'cooccurrence-matrix-heatmap',\r
  title: 'Cooccurrence Matrix Heatmap',\r
  desc: 'Cooccurrence Matrix Heatmap — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'CooccurrenceMatrixHeatmap',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-color"],\r
  tags: ["bars","cooccurrence-matrix-heatmap"],\r
}\r
\r
export default function CooccurrenceMatrixHeatmap({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = [[12,8,5,2],[8,15,9,4],[5,9,11,7],[2,4,7,10]]\r
    ...
    const color = d3.scaleSequential(d3.interpolateOranges).domain([0, maxV])\r
