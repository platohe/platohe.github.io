...
// SunburstFocused: One branch highlighted.\r
export const meta = {\r
  id: 'sunburst-focused',\r
  title: 'Sunburst Focused',\r
  desc: 'Sunburst Focused — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'SunburstFocused',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","sunburst-focused"],\r
}\r
\r
export default function SunburstFocused({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.selectAll('path').data(root.descendants()).join('path')\r
      ...
      .attr('fill-opacity', (d) => { let t = d; while (t.depth > 1) t = t.parent; return root.children.indexOf(t) === 1 ? 0.95 : 0.25 })\r
