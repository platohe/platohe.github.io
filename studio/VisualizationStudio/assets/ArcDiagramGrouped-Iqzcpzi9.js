...
// ArcDiagramGrouped: Teams clustered into departments with gaps.\r
const GROUPS = [["eng","qa","ops"],["des","mkt","sup"],["hr","fin"]]\r
export const meta = {\r
  id: 'arc-diagram-grouped',\r
  title: 'Arc Diagram Grouped',\r
  desc: 'Arc Diagram Grouped — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ArcDiagramGrouped',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","arc-diagram-grouped"],\r
}\r
\r
export default function ArcDiagramGrouped({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = {"nodes":[{"id":"eng","name":"Eng"},{"id":"des","name":"Design"},{"id":"mkt","name":"Marketing"},{"id":"ops","name":"Ops"},{"id":"qa","name":"QA"},{"id":"sup","name":"Support"},{"id":"hr","name":"People"},{"id":"fin","name":"Finance"}],"links":[{"source":"eng","target":"des","value":3},{"source":"eng","target":"qa","value":4},{"source":"mkt","target":"des","value":2},{"source":"ops","target":"sup","value":3},{"source":"hr","target":"fin","value":1},{"source":"mkt","target":"sup","value":1}]}\r
