...
// SunburstWide: Full-radius variant.\r
export const meta = {\r
  id: 'sunburst-wide',\r
  title: 'Sunburst Wide',\r
  desc: 'Sunburst Wide — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'SunburstWide',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","sunburst-wide"],\r
}\r
\r
export default function SunburstWide({ data: customData }) {\r
