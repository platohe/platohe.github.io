...
// ClusteringDendrogramAverage: average linkage.\r
export const meta = {\r
  id: 'clustering-dendrogram-average',\r
  title: 'Clustering Dendrogram Average',\r
  desc: 'Clustering Dendrogram Average — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'ClusteringDendrogramAverage',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["bars","clustering-dendrogram-average"],\r
}\r
\r
export default function ClusteringDendrogramAverage({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const merges = [[0,1,5],[3,4,7],[2,5,11],[6,7,18]]\r
    ...
    \r
    g.append('text').attr('x', W / 2).attr('y', 24).attr('text-anchor', 'middle').attr('font-size', '9px').attr('fill', 'var(--text-secondary)').text('average linkage dendrogram')\r
  }, [customData])\r
