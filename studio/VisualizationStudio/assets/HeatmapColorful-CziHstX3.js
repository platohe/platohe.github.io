...
\r
export const meta = {\r
  id: 'heatmap-colorful',\r
  title: 'Heatmap Colorful',\r
  desc: 'Heatmap Colorful — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'HeatmapColorful',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-color"],\r
  tags: ["bars","heatmap-colorful"],\r
}\r
\r
export default function HeatmapColorful({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const colorScale = d3.scaleSequential(d3.interpolateInferno).domain([minVal, maxVal])\r
