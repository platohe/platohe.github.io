...
// DendrogramLabeled: Leaf labels emphasized.\r
export const meta = {\r
  id: 'dendrogram-labeled',\r
  title: 'Dendrogram Labeled',\r
  desc: 'Dendrogram Labeled — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'DendrogramLabeled',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","dendrogram-labeled"],\r
}\r
\r
export default function DendrogramLabeled({ data: customData }) {\r
