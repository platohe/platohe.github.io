...
// ChordDiagramSparse: Four sports, generous padding, bold arcs.\r
export const meta = {\r
  id: 'chord-diagram-sparse',\r
  title: 'Chord Diagram Sparse',\r
  desc: 'Chord Diagram Sparse — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ChordDiagramSparse',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","chord-diagram-sparse"],\r
}\r
\r
export default function ChordDiagramSparse({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = { names: ["Soccer","Tennis","Golf","Rugby"], matrix: [[0,25,5,10],[25,0,8,4],[5,8,0,6],[10,4,6,0]] }\r
    const data = (customData && customData.matrix && customData.names) ? customData : DEFAULT_DATA\r
\r
    const cx = 200, cy = 150\r
    const outerRadius = 88\r
