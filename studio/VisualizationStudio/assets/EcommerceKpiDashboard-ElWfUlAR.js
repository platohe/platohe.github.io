...
// EcommerceKpiDashboard: KPI tiles + mini charts composition.\r
export const meta = {\r
  id: 'ecommerce-kpi-dashboard',\r
  title: 'Ecommerce Kpi Dashboard',\r
  desc: 'Ecommerce Kpi Dashboard — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'EcommerceKpiDashboard',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","ecommerce-kpi-dashboard"],\r
}\r
\r
export default function EcommerceKpiDashboard({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x', 24).attr('y', 34).attr('font-size', '11px').attr('font-weight', 700)\r
      .attr('fill', 'var(--text-secondary)').text('EcommerceKpi · This Week')\r
    const kpis = [["GMV","$880k",11],["AOV","$64",2],["Returns","4.2%",-8]]\r
    kpis.forEach((k, i) => {\r
      const x = 24 + i * 122\r
    ...
    const bars = [["Desktop",51],["Mobile",41],["App",8]]\r
    let by = 178\r
    bars.forEach((b, i) => {\r
