...
// DendrogramCompact: Tight spacing variant.\r
export const meta = {\r
  id: 'dendrogram-compact',\r
  title: 'Dendrogram Compact',\r
  desc: 'Dendrogram Compact — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'DendrogramCompact',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","dendrogram-compact"],\r
}\r
\r
export default function DendrogramCompact({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const layout = d3.cluster().size([200, 300])\r
    layout(root)\r
    const px = (d) => 34 + d.y\r
    const py = (d) => 45 + d.x\r
