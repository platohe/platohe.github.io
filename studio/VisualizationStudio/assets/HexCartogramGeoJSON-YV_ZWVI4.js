...
export const meta = {\r
  id: 'hex-cartogram-geo-json',\r
  title: 'Hex Cartogram Geo J S O N',\r
  desc: 'Hex Cartogram Geo J S O N — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'HexCartogramGeoJSON',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","hex-cartogram-geo-j-s-o-n"],\r
}\r
\r
export default function HexCartogramGeoJSON({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const proj = d3.geoConicEqualArea().fitSize([W-40, H-40], data)\r
    ...
    \r
    \r
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('HexCartogramGeoJSON - geoConicEqualArea')\r
  }, [customData])\r
