...
export const meta = {\r
  id: 'bullet-outliers-v2',\r
  title: 'Bullet Outliers V2',\r
  desc: 'Bullet Outliers V2 — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'BulletOutliersV2',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","bullet-outliers-v2"],\r
}\r
\r
export default function BulletOutliersV2({ data: customData }) {\r
  const ref=useRef(null)\r
  useEffect(()=>{\r
    const svg=d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT=[{label:'Sales', v:68},{label:'Profit',v:52},{label:'CSAT',v:82},{label:'Growth',v:96}]\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Bullet Outliers V2')\r
  },[customData])\r
