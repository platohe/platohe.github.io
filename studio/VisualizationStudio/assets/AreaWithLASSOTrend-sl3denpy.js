...
export const meta = {\r
  id: 'area-with-lassotrend',\r
  title: 'Area With L A S S O Trend',\r
  desc: 'Area With L A S S O Trend — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithLASSOTrend',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-l-a-s-s-o-trend"],\r
}\r
\r
export default function AreaWithLASSOTrend({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // LASSO trend (simplified - L1 penalty on slope changes)\r
    const lambda=0.1\r
    const trend=[]\r
    let prev=0\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with LASSO Trend')\r
