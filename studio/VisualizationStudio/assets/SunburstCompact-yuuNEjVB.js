...
// SunburstCompact: Small radius variant.\r
export const meta = {\r
  id: 'sunburst-compact',\r
  title: 'Sunburst Compact',\r
  desc: 'Sunburst Compact — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'SunburstCompact',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","sunburst-compact"],\r
}\r
\r
export default function SunburstCompact({ data: customData }) {\r
