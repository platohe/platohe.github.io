...
\r
export const meta = {\r
  id: 'radar-chart-nested',\r
  title: 'Radar Chart Nested',\r
  desc: 'Radar Chart Nested — a fun chart visualization',\r
  category: 'Fun',\r
  component: 'RadarChartNested',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["fun","radar-chart-nested"],\r
}\r
\r
export default function RadarChartNested({ data: customData }) {\r
