...
export const meta = {\r
  id: 'stacked-bar-with-outliers',\r
  title: 'Stacked Bar With Outliers',\r
  desc: 'Stacked Bar With Outliers — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'StackedBarWithOutliers',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","stacked-bar-with-outliers"],\r
}\r
\r
export default function StackedBarWithOutliers({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Stacked Bar with Outliers')\r
  },[customData])\r
