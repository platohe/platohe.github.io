...
export const meta = {\r
  id: 'world-choropleth-geo-json',\r
  title: 'World Choropleth Geo J S O N',\r
  desc: 'World Choropleth Geo J S O N — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'WorldChoroplethGeoJSON',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","world-choropleth-geo-j-s-o-n"],\r
}\r
\r
export default function WorldChoroplethGeoJSON({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const proj = d3.geoOrthographic().fitSize([W-40, H-40], data)\r
    ...
    \r
    \r
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('WorldChoroplethGeoJSON - geoOrthographic')\r
  }, [customData])\r
