...
export const meta = {\r
  id: 'ridge-with-deviation',\r
  title: 'Ridge With Deviation',\r
  desc: 'Ridge With Deviation — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'RidgeWithDeviation',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","ridge-with-deviation"],\r
}\r
\r
export default function RidgeWithDeviation({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Ridge with Deviation')\r
  },[customData])\r
