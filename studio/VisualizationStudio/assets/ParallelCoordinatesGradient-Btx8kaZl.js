...
// ParallelCoordinatesGradient: Stroke color by overall score.\r
export const meta = {\r
  id: 'parallel-coordinates-gradient',\r
  title: 'Parallel Coordinates Gradient',\r
  desc: 'Parallel Coordinates Gradient — a lines chart visualization',\r
  category: 'Lines',\r
  component: 'ParallelCoordinatesGradient',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["lines","parallel-coordinates-gradient"],\r
}\r
\r
export default function ParallelCoordinatesGradient({ data: customData }) {\r
...
\r
    ...
    \r
    data.rows.forEach((r) => {\r
      const total = d3.mean(data.headers, h => r[h]); const c = d3.interpolateRgbBasis(colors)(total / 100)\r
