...
export const meta = {\r
  id: 'cartogram-geo-json2',\r
  title: 'Cartogram Geo J S O N2',\r
  desc: 'Cartogram Geo J S O N2 — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'CartogramGeoJSON2',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","cartogram-geo-j-s-o-n2"],\r
}\r
\r
export default function CartogramGeoJSON2({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('CartogramGeoJSON2 - geoOrthographic')\r
  }, [customData])\r
