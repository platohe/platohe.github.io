...
// ParallelCoordinatesCompact: Compact spacing, thin chrome.\r
export const meta = {\r
  id: 'parallel-coordinates-compact',\r
  title: 'Parallel Coordinates Compact',\r
  desc: 'Parallel Coordinates Compact — a lines chart visualization',\r
  category: 'Lines',\r
  component: 'ParallelCoordinatesCompact',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["lines","parallel-coordinates-compact"],\r
}\r
\r
export default function ParallelCoordinatesCompact({ data: customData }) {\r
...
\r
    ...
    data.headers.forEach((h, i) => {\r
      ...
      g.append('text').attr('x', x).attr('y', y0 + 12).attr('text-anchor', 'middle')\r
