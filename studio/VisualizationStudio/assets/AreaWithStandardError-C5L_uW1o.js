...
export const meta = {\r
  id: 'area-with-standard-error',\r
  title: 'Area With Standard Error',\r
  desc: 'Area With Standard Error — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithStandardError',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-standard-error"],\r
}\r
\r
export default function AreaWithStandardError({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    g.append('path').datum(bands).attr('d',d3.line().x(d=>x(d.x)).y(d=>y(d.mean)).curve(d3.curveBasis)).attr('fill','none').attr('stroke',colors[0]).attr('stroke-width',1.8)\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Standard Error')\r
