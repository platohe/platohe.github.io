...
export const meta = {\r
  id: 'area-with-renewal-process',\r
  title: 'Area With Renewal Process',\r
  desc: 'Area With Renewal Process — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithRenewalProcess',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-renewal-process"],\r
}\r
\r
export default function AreaWithRenewalProcess({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Renewal process\r
    const interArrival=12\r
    const renewals=d3.range(0,60,12)\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Renewal Process')\r
