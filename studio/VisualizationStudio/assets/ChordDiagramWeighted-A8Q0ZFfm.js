...
// ChordDiagramWeighted: Extreme ribbon widths by tonnage.\r
export const meta = {\r
  id: 'chord-diagram-weighted',\r
  title: 'Chord Diagram Weighted',\r
  desc: 'Chord Diagram Weighted — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ChordDiagramWeighted',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","chord-diagram-weighted"],\r
}\r
\r
export default function ChordDiagramWeighted({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = { names: ["Iron","Copper","Lithium","Cobalt","Nickel"], matrix: [[0,80,45,20,60],[80,0,30,15,50],[45,30,0,70,40],[20,15,70,0,55],[60,50,40,55,0]] }\r
...
\r
    ...
    flat.forEach(cd => {\r
      ...
      svg.append('path').attr('d', ribbon(cd)).attr('transform', tr)\r
        ...
        .attr('fill-opacity', 0.75 * (0.55 + 0.45*cd.source.value/maxV))\r
