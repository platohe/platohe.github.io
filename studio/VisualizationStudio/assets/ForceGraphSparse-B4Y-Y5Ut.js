...
// ForceGraphSparse: Few long links.\r
export const meta = {\r
  id: 'force-graph-sparse',\r
  title: 'Force Graph Sparse',\r
  desc: 'Force Graph Sparse — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ForceGraphSparse',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["networks","force-graph-sparse"],\r
}\r
\r
export default function ForceGraphSparse({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const DEFAULT_DATA = { nodes: [\r
      ...
      links: [{"source":0,"target":4,"value":1},{"source":2,"target":6,"value":1},{"source":1,"target":7,"value":1}] }\r
