...
export const meta = {\r
  id: 'theme-river-with-deviation',\r
  title: 'Theme River With Deviation',\r
  desc: 'Theme River With Deviation — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'ThemeRiverWithDeviation',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","theme-river-with-deviation"],\r
}\r
\r
export default function ThemeRiverWithDeviation({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    g.append('line').attr('x1',0).attr('x2',width).attr('y1',y(avg/3)).attr('y2',y(avg/3)).attr('stroke','#0f172a').attr('stroke-width',1).attr('stroke-dasharray','3,2').attr('opacity',0.42)\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('ThemeRiver with Deviation')\r
  },[customData])\r
