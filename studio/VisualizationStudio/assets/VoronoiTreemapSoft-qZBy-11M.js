...
// VoronoiTreemapSoft: Nested polygonal treemap variant 5.\r
export const meta = {\r
  id: 'voronoi-treemap-soft',\r
  title: 'Voronoi Treemap Soft',\r
  desc: 'Voronoi Treemap Soft — a math & simulation chart visualization',\r
  category: 'Math & Simulation',\r
  component: 'VoronoiTreemapSoft',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["math-&-simulation","voronoi-treemap-soft"],\r
}\r
\r
export default function VoronoiTreemapSoft({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    void customData\r
    const g = svg.append('g')\r
    const rawWeights = [["Core",44,0],["Soft",28,1],["Edge",16,2]]\r
