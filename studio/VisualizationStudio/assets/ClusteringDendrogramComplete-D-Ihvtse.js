...
// ClusteringDendrogramComplete: complete linkage.\r
export const meta = {\r
  id: 'clustering-dendrogram-complete',\r
  title: 'Clustering Dendrogram Complete',\r
  desc: 'Clustering Dendrogram Complete — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'ClusteringDendrogramComplete',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["bars","clustering-dendrogram-complete"],\r
}\r
\r
export default function ClusteringDendrogramComplete({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    const merges = [[0,1,8],[3,4,9],[2,5,14],[6,7,22]]\r
    ...
    \r
    g.append('text').attr('x', W / 2).attr('y', 24).attr('text-anchor', 'middle').attr('font-size', '9px').attr('fill', 'var(--text-secondary)').text('complete linkage dendrogram')\r
  }, [customData])\r
