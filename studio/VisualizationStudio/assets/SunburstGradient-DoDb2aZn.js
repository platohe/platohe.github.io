...
// SunburstGradient: Opacity fades by depth.\r
export const meta = {\r
  id: 'sunburst-gradient',\r
  title: 'Sunburst Gradient',\r
  desc: 'Sunburst Gradient — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'SunburstGradient',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","sunburst-gradient"],\r
}\r
\r
export default function SunburstGradient({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    g.selectAll('path').data(root.descendants()).join('path')\r
      ...
      .attr('fill-opacity', (d) => 0.95 - d.depth * 0.18)\r
