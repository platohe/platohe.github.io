...
export const meta = {\r
  id: 'area-with-bocpdchange-point',\r
  title: 'Area With B O C P D Change Point',\r
  desc: 'Area With B O C P D Change Point — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithBOCPDChangePoint',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-b-o-c-p-d-change-point"],\r
}\r
\r
export default function AreaWithBOCDChangePoint({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // BOCPD (Bayesian Online Change Point Detection)\r
    let runLength=0\r
    const cpProbs=[]\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with BOCPD')\r
