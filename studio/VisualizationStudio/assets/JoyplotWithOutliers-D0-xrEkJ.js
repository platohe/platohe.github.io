...
export const meta = {\r
  id: 'joyplot-with-outliers',\r
  title: 'Joyplot With Outliers',\r
  desc: 'Joyplot With Outliers — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'JoyplotWithOutliers',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","joyplot-with-outliers"],\r
}\r
\r
export default function JoyplotWithOutliers({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Joyplot with Outliers')\r
  },[customData])\r
