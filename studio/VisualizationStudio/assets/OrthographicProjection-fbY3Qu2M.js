...
export const meta = {\r
  id: 'orthographic-projection',\r
  title: 'Orthographic Projection',\r
  desc: 'Orthographic Projection — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'OrthographicProjection',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","orthographic-projection"],\r
}\r
\r
export default function OrthographicProjection({ data: customData }) {\r
  ...
  useEffect(() => {\r
    ...
    \r
    \r
    g.append('text').attr('x',W/2).attr('y',H-8).attr('text-anchor','middle').attr('fill','var(--text-secondary)').attr('font-size','7px').text('OrthographicProjection - geoMercator')\r
  }, [customData])\r
