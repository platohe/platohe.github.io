...
export const meta = {\r
  id: 'diverging-bar-with-error',\r
  title: 'Diverging Bar With Error',\r
  desc: 'Diverging Bar With Error — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'DivergingBarWithError',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["bars","diverging-bar-with-error"],\r
}\r
\r
export default function DivergingBarWithError({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Diverging Bar with Error')\r
  },[customData])\r
