...
export const meta = {\r
  id: 'area-with-exponential-smoothing',\r
  title: 'Area With Exponential Smoothing',\r
  desc: 'Area With Exponential Smoothing — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithExponentialSmoothing',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-exponential-smoothing"],\r
}\r
\r
export default function AreaWithExponentialSmoothing({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    const alpha=0.3\r
    const smoothed=[]\r
    let prev=curveData[0].y\r
    curveData.forEach(d=>{\r
      prev=alpha*d.y+(1-alpha)*prev\r
      smoothed.push({x:d.x, y:prev})\r
    })\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Exponential Smoothing')\r
