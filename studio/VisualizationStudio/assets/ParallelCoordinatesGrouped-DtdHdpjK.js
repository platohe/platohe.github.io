...
// ParallelCoordinatesGrouped: Color groups with legend chips.\r
export const meta = {\r
  id: 'parallel-coordinates-grouped',\r
  title: 'Parallel Coordinates Grouped',\r
  desc: 'Parallel Coordinates Grouped — a lines chart visualization',\r
  category: 'Lines',\r
  component: 'ParallelCoordinatesGrouped',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["lines","parallel-coordinates-grouped"],\r
}\r
\r
export default function ParallelCoordinatesGrouped({ data: customData }) {\r
...
\r
    ...
    data.rows.forEach((r, idx) => {\r
      const groups = [[0, 1], [2, 3], [4]]; const gi = groups.findIndex(gg => gg.includes(idx)); const c = gi < 0 ? '#94a3b8' : colors[gi % colors.length]\r
