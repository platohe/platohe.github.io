...
// VoronoiTreemapSectors: Nested polygonal treemap variant 1.\r
export const meta = {\r
  id: 'voronoi-treemap-sectors',\r
  title: 'Voronoi Treemap Sectors',\r
  desc: 'Voronoi Treemap Sectors — a math & simulation chart visualization',\r
  category: 'Math & Simulation',\r
  component: 'VoronoiTreemapSectors',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-hierarchy"],\r
  tags: ["math-&-simulation","voronoi-treemap-sectors"],\r
}\r
\r
export default function VoronoiTreemapSectors({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    void customData\r
    const g = svg.append('g')\r
    const rawWeights = [["Market A",34,0],["Market B",26,1],["Market C",18,2],["Market D",12,3],["Other",8,4]]\r
