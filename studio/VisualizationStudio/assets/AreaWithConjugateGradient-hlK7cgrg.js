...
export const meta = {\r
  id: 'area-with-conjugate-gradient',\r
  title: 'Area With Conjugate Gradient',\r
  desc: 'Area With Conjugate Gradient — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithConjugateGradient',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-conjugate-gradient"],\r
}\r
\r
export default function AreaWithConjugateGradient({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Conjugate gradient optimization path\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Conjugate Gradient')\r
