...
export const meta = {\r
  id: 'letter-value-with-avg',\r
  title: 'Letter Value With Avg',\r
  desc: 'Letter Value With Avg — a bars chart visualization',\r
  category: 'Bars',\r
  component: 'LetterValueWithAvg',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["bars","letter-value-with-avg"],\r
}\r
\r
export default function LetterValueWithAvg({ data: customData }) {\r
  ...
  useEffect(()=>{\r
    ...
    raw.forEach((vals,i)=>{\r
      ...
      const m=d3.median(sorted)||0, mean=d3.mean(vals)||0\r
      ...
      g.append('circle').attr('cx',cx).attr('cy',y(mean)).attr('r',2).attr('fill','#0f172a')\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Letter-Value with Avg')\r
  },[customData])\r
