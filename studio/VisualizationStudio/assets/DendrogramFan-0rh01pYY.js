...
// DendrogramFan: Fan projection around origin.\r
export const meta = {\r
  id: 'dendrogram-fan',\r
  title: 'Dendrogram Fan',\r
  desc: 'Dendrogram Fan — a hierarchies chart visualization',\r
  category: 'Hierarchies',\r
  component: 'DendrogramFan',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale"],\r
  tags: ["hierarchies","dendrogram-fan"],\r
}\r
\r
export default function DendrogramFan({ data: customData }) {\r
