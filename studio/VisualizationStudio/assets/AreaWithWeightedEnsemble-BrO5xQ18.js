...
export const meta = {\r
  id: 'area-with-weighted-ensemble',\r
  title: 'Area With Weighted Ensemble',\r
  desc: 'Area With Weighted Ensemble — a areas chart visualization',\r
  category: 'Areas',\r
  component: 'AreaWithWeightedEnsemble',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-axis"],\r
  tags: ["areas","area-with-weighted-ensemble"],\r
}\r
\r
export default function AreaWithWeightedEnsemble({ data: customData, onCurveData }) {\r
...
\r
  ...
  useEffect(()=>{\r
    ...
    // Weighted ensemble with performance-based weights\r
    const numModels=5\r
    ...
    const ensemble=curveData.map((_,i)=>({\r
      x:curveData[i].x,\r
      y:d3.sum(models.map((t,j)=>t[i].y*weights[j]))\r
    }))\r
    ...
    svg.append('text').attr('x',200).attr('y',14).attr('text-anchor','middle').attr('fill','var(--text)').attr('font-size','11px').attr('font-weight',600).text('Area with Weighted Ensemble')\r
