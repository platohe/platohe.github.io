...
// ChordDiagramHierarchical: Industry rollup with sub-team labels.\r
export const meta = {\r
  id: 'chord-diagram-hierarchical',\r
  title: 'Chord Diagram Hierarchical',\r
  desc: 'Chord Diagram Hierarchical — a networks chart visualization',\r
  category: 'Networks',\r
  component: 'ChordDiagramHierarchical',\r
  complexity: 'beginner',\r
  interactivity: ["none"],\r
  d3Api: ["d3-scale","d3-shape"],\r
  tags: ["networks","chord-diagram-hierarchical"],\r
}\r
\r
export default function ChordDiagramHierarchical({ data: customData }) {\r
  const ref = useRef(null)\r
  useEffect(() => {\r
    const svg = d3.select(ref.current); svg.selectAll('*').remove()\r
    const DEFAULT_DATA = { names: ["Corp","Div A","Div B","Team 1","Team 2","Team 3"], matrix: [[0,40,30,0,0,0],[40,0,0,22,18,0],[30,0,0,0,14,16],[0,22,0,0,0,0],[0,18,0,0,0,0],[0,0,16,0,0,0]] }\r
